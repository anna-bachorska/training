...
function nameValidation() {
  ...
  if (nameLength < MIN_LENGTH) {
    document.getElementById("nameValidationMessage").innerHTML = "Your name is too short*";
    nameInput.classList.add("nameInput");
    return false;
  } else if (nameLength > MAX_LENGTH) {
    document.getElementById("nameValidationMessage").innerHTML = "Your name is too long*";
    nameInput.classList.add("nameInput");
    return false;
...
function surnameValidation() {
  ...
  if (surnameLength < MIN_LENGTH) {
    document.getElementById("surnameValidationMessage").innerHTML = "Your surname is too short*";
    surnameInput.classList.add("surnameInput");
    return false;
  } else if (surnameLength > MAX_LENGTH) {
    document.getElementById("surnameValidationMessage").innerHTML = "Your surname is too long*";
    surnameInput.classList.add("surnameInput");
    return false;
...
function githubValidation() {
  ...
  if (githubLength < MIN_LENGTH) {
    document.getElementById("githubValidationMessage").innerHTML = "Your github is too short*";
    githubInput.classList.add("githubInput");
    return false
  } else if (githubLength > MAX_LENGTH) {
    document.getElementById("githubValidationMessage").innerHTML = "Your github is too long*";
    githubInput.classList.add("githubInput");
    return false
  } else {
...
//fetch POST
const URL = 'https://pxia4wkbor5nqoq3yx3njuvfc40qkcfa.lambda-url.us-east-1.on.aws/'
...
const URL_GET = 'https://ipcl32yuj4hzjss4l6yek7prt40wopeg.lambda-url.us-east-1.on.aws/'
